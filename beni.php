        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    <div class="one-third"><img src="style/images/profes/benita 288.png" alt="" /></div>
                    <div class="two-third last">
                        <h1>BENITA ZU&Ntilde;IGA FUENTES</h1>
                        ...
                        <br/>
                        <h2>Cargo</h2>
                        <p>Asistente de la Divisi&oacute;n de Mecatr&oacute;nica y TIC.</p>
                        <br/>
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    <h4>CARRERA T&Eacute;CNICA DE SECRETARIA</h4>                                    
                                </div>
                            </div>
                        </div>
                    ...
                    $rs=mysql_query("select acercami from acerca where idusuario='bzunigaf'") or die("Error: ".mysql_error());
                    ?>                   
                ...
                <div id="footer">
                    ...
                    <div class="one-fourth">
                        ...
                        <ul class="latest-posts">
                            <li><span class="date"><img src="style/images/icon-ut.png" alt="Twitter" /></span>bzunigaf@utsjr.edu.mx</li>                            
                        </ul>
                    </div>
