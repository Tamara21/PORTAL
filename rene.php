        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    $rs=mysql_query("select acercami from acerca where idusuario='rsantoso'") or die("Error: ".mysql_error());
                    ?>                   
                ...
                <div id="footer">
                    ...
                    <div class="one-fourth">
                        ...
                        <ul class="flickr">
                            <li><a href="dora.php"><img src="style/images/profes/dor.png" alt="" /></a></li>
