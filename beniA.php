        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <?php        		
                    $consultar=mysql_query("SELECT * FROM acerca where idusuario='bzunigaf'");
                    ...
                    echo"    					
                    <form action='benim.php' method='POST' id='formulario' >
                    <table>
                    <thead>
                    <tr>
                    ...
                    <td align='left'>            			           
                    <textarea name='beni' id='beni' rows='10' cols='50' required> $acerca </textarea>
