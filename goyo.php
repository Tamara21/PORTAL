            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <div class="two-third last">
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    ...
                                    <p><img src="style/images/profes/ITQ.png" class="left" alt="" />Ingenier&iacute;a en Sistemas Computacionales</p>
                                </div>
                            </div>
                        </div>
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Maestria</h2>
                            <div class="togglebox">
                                <div>
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Especialidades</h2>
                            <div class="togglebox">
                                <div>
                                    <ul>  
                    ...
                    $rs = mysql_query("select acercami from acerca where idusuario='grodriguezm'") or die("Error: " . mysql_error());
                    ?>                   
                ...
                <div id="footer">
                    ...
                    <div class="one-fourth">
                        ...
                        <ul class="flickr">
                            <li><a href="rafa.php"><img src="style/images/profes/raf.png" alt="" /></a></li>
                            ...
                            <li><a href="beni.php"><img src="style/images/profes/ben.png" alt="" /></a></li>
