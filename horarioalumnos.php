    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity"> 
                <?php        		
                $consultar=mysql_query("SELECT * FROM horarioalumnos");

                while($horariosalumno=mysql_fetch_array($consultar)){     
                $grupo=$horariosalumno['grupo'];
                $imagen=$horariosalumno['ruta'];//se le pone 'nombre' porque lleva el nombre/url del campo de la BD
                echo "
                <br />
                <br />
                <br />	
