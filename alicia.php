            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <div class="two-third last">
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Maestr&iacute;a</h2>
                            <div class="togglebox">
                                <div>
                                    <h4>Universidad del Valle de M&eacute;xico</h4>
                                    <p><img src="style/images/profes/UVM.png" class="left" alt="" /></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Toggle -->
                    ...
                    $rs=mysql_query("select acercami from acerca where idusuario='acortesg'") or die("Error: ".mysql_error());
                    ?>                   
