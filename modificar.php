            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <div class="two-third last">
                        ...
                        $rs=mysql_query("select * from usuarios where idusuario='$idusuario'") or die("Error: ".mysql_error());

                        $encontrado="false";

                        while($row=mysql_fetch_array($rs)){
                        ?>
                        <p> <form action="modificar2.php" method="POST" id="formulario" enctype="multipart/form-data">
                            <table width="225px" cellspacing="2" cellpadding="2" border="0px" bordercolor="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left"><input type="text" name="idusuario" id="idusuario" value="<?php echo $row["idusuario"];?>" readonly/>            </td>
                                </tr>
                                <tr>
                                    <td align="right">Password:</td>
                                    <td align="left"><input type="password" name="password" id="password" value="<?php echo $row["password"];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td align="left"><input type="password" name="password2" id="password2" value="<?php echo $row["password"];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td align="left"><input type="text" name="nombre" id="nombre" value="<?php echo $row["nombre"];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td align="left"><input type="text" name="apellidos" id="apellidos" value="<?php echo $row["apellidos"];?>"/>
                                                            <div id="errorApellido" style="display:none;color:red;" >
                                            Debes escribir los apellidos.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">Tipo de usuario:</td>
                                    <td align="left"><select name="tipousuario" id="tipousuario">
                                            <option value="<?php echo $row["tipousuario"];?>">--</option>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <button type="submit" name="guardar" id="guardar"  class='log' value="guardar">Guardar</button>
                                        <button type="submit" name="eliminar" id="eliminar" class='log' value="eliminar">Eliminar</button>
                                        <button type="submit" name="cancelar" id="cancelar"  class='log'value="cancelar   ">Cancelar</button></td>
                                </tr>
                            </table>                   
                        </form>
                        <?php
