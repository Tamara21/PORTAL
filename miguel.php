            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <div class="two-third last">
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    ...
                                    <p><img src="style/images/profes/UM.png" class="left" alt="" />LICENCIATURA EN COMUNICACI&Oacute;N.</p>
                                </div>
                            </div>
                        </div>                        
                        <!-- End Toggle -->
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Reconocimientos</h2>
                            <div class="togglebox">
                                <div>
                                    <ul> 
                    ...
                    $rs=mysql_query("select acercami from acerca where idusuario='magonzalezp'") or die("Error: ".mysql_error());
                    ?>                   
