...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Modificar horarios del Alumno</title>
    ...
    <script>
            $(document).ready(function() {
                $("#formulario").submit(function() {
                    ...
                    {
                        $("#errorgrupo").css("display", "inline");
                        $("#grupo").focus();
                        return false;
                    }
                    else {

                        $("#errorgrupo").css("display", "none");
                    }

                    if ($("#ruta").val().length === 0)
                            //$("#ruta").val().indexOf ('style/imghorariosalum/')||
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="container" class="opacity"> 
            ...
            $rs=mysql_query("select * from horariosalumno where id='$id'")
            ...
            <table>
                <form action="modificarhorarioalumnos.php" method="post" name="formulario" id="formulario">
                    ...
                    <tr>
                        <td class="derecha">Grupo:</td>
                        <td class="izquierda">
                            <input type="text" name="grupo" id="grupo" value="<?php
                                   echo $row["grupo"]?>"  required />
            ...
            $horario="listadohorarioalumnos.php";
            echo "<br /><br /> <a href=$horario>Buscar otro</a>";
