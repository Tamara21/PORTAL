...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Listado de horarios del Profesor</title>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity"> 
                <h1>Listado de horarios profesor</h1>
                <h4>Clic en el Id del horario del profesor que deseas modificar</h4>

                <?php

                //ejecutamos la sentencia SQL	
                $rs=mysql_query("select * from horarioprofesores")
                ...
                <table width="900" border="0">
                    <tr>
                        ...
                        <td width="200">Nombre profesor(a)</td>
                    ...
                    $id=$row["id"];
                    $horarioprofe="modificarhorarioprofe.php?id=$id";

                    echo "<tr>";
                    echo "<td><a href=$horarioprofe>".$row["id"]."</a></td>";
