        ...
        <div id="wrapper">
            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    <div class="one-third"><img src="style/images/profes/fide 288.png" alt="" /></div>
                    <div class="two-third last">
                        <h1>FIDENCIO D&iacute;AZ MENDEZ</h1>

                        <h2>Grado Profesional</h2>
                        <p>Maestr&iacute;a</p>
                        <br/>   
                        <h2>Fecha de nacimiento</h2>
                        <p>1 de Noviembre de 1967</p>
                        <br/>
                        <h2>Cargo</h2>
                        <p>Director de Divisi&oacute;n</p>
                        <br/>                        
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    <h4>Universidad Aut&oacute;noma Metropolitana. Unidad Azcapotzalco.</h4>
                                    <p><img src="style/images/art/c3.jpg" class="left" alt="" />Ingenier&iacute;a en Electr&oacute;nica. Especialidad en Instrumentaci&oacute;n y Control. </p>
                                </div>
                            </div>
                        </div>
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    <h4>Universidad ETAC.</h4>
                                    <p><img src="style/images/art/c3.jpg" class="left" alt="" />Administraci&oacute;n de procesos industriales.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    ...
                                    <p><img src="style/images/art/c3.jpg" class="left" alt="" />Doctorado en administraci&oacute;n. Tesis en tr&aacute;mite.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="toggle">
                            ...
                            <div class="togglebox">
                                <div>
                                    <ul>
                                        <li>iCarnegie</li>
                                        <li>Metodolog&iacute;a de ense&ntilde;anza iCarnegie</li>
                    ...
                    <?php
                    $consultar = mysql_query("SELECT * FROM acerca where idusuario='fdiazm'");
                    while ($profe = mysql_fetch_array($consultar)) {
                        ...
                        echo"    					
					<form action='fidem.php' method='POST' id='formulario' >
					<table>
                 <thead>
                     <tr>
                    ...
                    <h4>Informaci&oacute;n</h4>
                     ...
                     <td align='left'>            			           
            			<textarea name='fide' id='fide' rows='10' cols='50' required> $acerca </textarea>
					
						<div id='erroracerca' style='display:none;color:red'>
						Debes de ingresar un mensaje.
			            </div>
                        </td>      
                 </tr>
                ...
                <div id="footer">
                    ...
                    <div class="one-fourth">
                        ...
                        <ul class="latest-posts">
                            <li><span class="date"><img src="style/images/icon-linkedin.png" alt="Linkedin" /></span>fide.diaz</li>
                            <li><span class="date"><img src="style/images/icon-skype.png" alt="Skype" /></span>fide.diaz</li>
                            <li><span class="date"><img src="style/images/icon-ut.png" alt="Twitter" /></span>fdiazm@utsjr.edu.mx</li>                            
                        </ul>
                    </div>
