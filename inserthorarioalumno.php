...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Insertar Horario del Alumno</title>
        ...
        <div id="wrapper">
            ...
            <div id="menu" class="menu opacity">
                ...
                <li><a href="#" class="active">Alumno</a>
                    <ul>
                        <li><a href="inserthorarioalumno.php" class="active">Ingresar horario</a></li>
            ...
            <div id="container" class="opacity"> 
                ...
                <form action="nuevoalumno.php" method="POST" id="formulario" enctype="multipart/form-data">
                    <table>
                        <thead>
                            <tr>
                                <th colspan="2">
                        ...
                        <!-- Inicio de fila -->
                        <tr>
                            <td align="rigth">Grupo:</td> 
                            <td align="left">
                                <input type="text" name="grupo" id="grupo" required autofocus placeholder="ejemplo TIC01SM-13"/>
                                <div id="errorgrupo" style="display:none;color:red">
                                    Debes ingresar el grupo ejemplo TIC01SM-13
                                </div>
                            </td>      
                        </tr>
                        <!-- Fin de la fila -->
