            ...
            <div id="container" class="opacity">
                <div class="full-width">
                    ...
                    <div class="two-third last">
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Materias a lo largo de su desempe&ntilde;o docente</h2>
                            <div class="togglebox">
                                <div>
                                    <h4>Materias</h4>
                                    <p><ol>
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Licenciatura</h2>
                            <div class="togglebox">
                                <div>
                                    <h4>Instituto Tecnol&oacute;gico Superior del Oriente del Estado de Hidalgo (ITESA)</h4>
                                    <p><img src="style/images/profes/ITESA.png" class="left" alt="" />Ingenier&iacute;a en Sistemas Computacionales</p>
                                </div>
                            </div>
                        </div>                        
                        <!-- End Toggle -->
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Cursos</h2>
                            <div class="togglebox">
                                <div>
                                    <ul>
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Congresos</h2>
                            <div class="togglebox">
                                <div>
                                    <ul>                                       
                                        <li>COIN</li>
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Certificaciones</h2>
                            <div class="togglebox">
                                <div>
                                    <ul> 
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Talleres</h2>
                            <div class="togglebox">
                                <div>
                                    <ul> 
                        ...
                        <div class="toggle">
                            <h2 class="trigger" title="Presione el texto para desplegar la informaci&oacute;n">Diplomados</h2>
                            <div class="togglebox">
                                <div>
                                    <ul> 
                    ...
                    //invocamos la funcion de conectar
                    conectarBD();
                    //ejecutamos la sentencia sql
                    $rs = mysql_query("select acercami from acerca where idusuario='dllopeza'") or die("Error: " . mysql_error());
                    ?>                   

                    <?php
                    $row = mysql_fetch_array($rs);
                    echo "<p style='text-align: justify'>" . $row["acercami"] . "</p>";
                    ?>
                    <div class="clear"></div>
                </div>
                <!-- End Full Width -->
                ...
                <div id="footer">
                    ...
                    <div class="one-fourth">
                        ...
                        <ul class="flickr">
                            <li><a href="alicia.php"><img src="style/images/profes/al.png" alt="" /></a></li>
                            <li><a href="alex.php"><img src="style/images/profes/ale.png" alt="" /></a></li>
                            <li><a href="fide.php"><img src="style/images/profes/fid.png" alt="" /></a></li>
                            <li><a href="hector.php"><img src="style/images/profes/hec.png" alt="" /></a></li>
                            <li><a href="miguel.php"><img src="style/images/profes/mig.png" alt="" /></a></li>
                            <li><a href="goyo.php"><img src="style/images/profes/gre.png" alt="" /></a></li>
                            <li><a href="marisol.php"><img src="style/images/profes/mar.png" alt="" /></a></li>
                            <li><a href="brenda.php"><img src="style/images/profes/bre.png" alt="" /></a></li>
                            <li><a href="memo.php"><img src="style/images/profes/mem.png" alt="" /></a></li>
                        </ul>
                    </div>
